...
PLACE = [
    ...
    ('C7',  7.15, 1.7,  90, False), ('C8', 8.45, 1.7, 90, False),
    ('C3',  6.25, 3.9,  90, False), ('C4', 7.2, 3.9, 90, False), ('C5', 8.15, 3.9, 90, False),
    ('C6',  6.35, 5.9,  90, False), ('C9', 7.8, 6.2, 90, False),
    ('R1',  6.4,  7.9,  90, False), ('R2', 6.4, 9.8, 90, False), ('TH1', 7.5, 9.8, 90, False),
    ('L1',  1.2, 13.0,   0, False),
    # --- 5V rail parts, top strip ---
    ('C10', 9.55, 1.3,  90, False), ('C11',10.7, 1.3, 90, False),
    ('R3', 11.65, 1.25, 90, False), ('R4', 12.55, 1.25, 90, False),
    ('C27', 9.15, 4.0,  90, False),
    # --- crystal ---
    ('Y1', 13.8,  3.65,  0, False),
    ('C32',11.3,  3.6,  90, False), ('C33',16.3, 3.6, 90, False),
    # --- LDO ---
    ('U2', 10.9,  8.0, 180, False),
    ('C12', 8.9, 10.4,   0, False), ('C13',11.1, 10.4, 0, False), ('C14',12.9, 11.0, 90, False),
    # --- nRF52832 ---
    ('U3', 16.9,  8.8,  90, False),
    ('C25',14.0, 13.8,  90, False), ('C26',15.05, 13.7, 90, False),
    ('C28',15.95, 13.7, 90, False), ('C29',16.85, 13.7, 90, False),
    ('C30',17.75, 13.7, 90, False), ('C31',18.65, 13.7, 90, False),
    ('L2', 20.0, 14.0,  90, False), ('L3', 21.4, 13.6, 90, False),
    # --- RF corner ---
    ...
    ('TP1',13.8, 16.6,   0, False), ('TP2',13.8, 18.4, 0, False), ('TP3',13.8, 20.2, 0, False),
