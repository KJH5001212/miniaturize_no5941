...
| E1 | Johanson 2450AT07A0100 | **1.0×0.5×0.37 mm (0402), 4단자** | 2.4 GHz 칩안테나 — 단자 1·4=Feed, **2·3=GND**(데이터시트 36S0021A Rev4.1 확정, 좌측 GND 포어에 스트립 연결). 전층 구리금지 ~5×3 mm 킵아웃 + pi 슬롯(C35/R15/C34) 실보드 튜닝 필수 |
| U4 | LPV802DGKR | VSSOP-8 | A: 컨트롤 앰프 / B: TIA — 나노파워 0.32 µA/ch, Ib 0.1 pA |
| U5 | REF35102QDBVR | SOT-23-6 | 1.024 V 레퍼런스 |
| BT1 | LIR2032 **탭 용접형(솔더탭)** | 뒷면 패드 2개 | 3.7 V / ~40 mAh — Keystone 3034 홀더는 폭 27 mm로 23.4×22 mm 보드에 안 들어가 탭셀 채택 (뒷면 중앙 Ø21 배치구역 확보). 보호회로 없음 — 펌웨어 컷오프 필수 |
...
| C34, C35 | (DNP) ×2 | C0G | 안테나 pi 튜닝 션트 슬롯 |
...
| R14 | 1 kΩ | — | LED 직렬 |
| R15 | 0 Ω | 0402 | 안테나 pi 튜닝 직렬 슬롯 (C35·C34 션트와 함께 션트-직렬-션트 — 2450AT07A0100 데이터시트 요구) |
...
- U4 업그레이드 옵션(핀호환): LPV812(오프셋 ±0.3 mV 정밀형) · OPA2391(fA급 Ib, 22 µA/ch — 이전 채택품).
